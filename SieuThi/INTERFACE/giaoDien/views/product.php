    ...
    <div class="container-fluid">
        ...
        <div class="roww">
            ...
            <div class="col-lg-10 products">
                <div class="rowsp">
                    <a href="#" class="col-lg-4" style="text-decoration:none; color: black;">
                      <h4 >Sản phẩm</h4>
                    </a>
                ...
                <div class="row">
                  ...
                  <?php
                  $sql = 'select quanlity * price AS total_price,image, infor, product_name, quanlity, price from products;';
