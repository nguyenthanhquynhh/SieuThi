    ...
    <div class="container-fluid">
        <div class="roww">
            ...
            <div class="col-lg-10 products">
                <div class="row">
                    <a href="#" class="col-lg-4" style="text-decoration:none; color: black;"><h4 >Các loại hạt</h4></a>
                ...
                <div class="row">
                  ...
                  <?php
                  $sql = 'SELECT products.*, brands.brand_name FROM products INNER JOIN brands ON products.brand_id = brands.brand_id WHERE brands.brand_name = "Các loại hạt"';
