    ...
    <div class="container-fluid">
        <div class="roww">
            ...
            <div class="col-lg-10 products">
                <div class="row">
                    <a href="#" class="col-lg-4" style="text-decoration:none; color: black;"><h4 >Các loại quả</h4></a>
                ...
                <div class="row">
                  ...
                  <?php
                  $sql = 'SELECT products.*, brands.brand_name FROM products INNER JOIN brands ON products.brand_id = brands.brand_id WHERE brands.brand_name = "Hoa quả"';
                  ...
                  ?>
                    <!-- <div class="col-lg-2 product_item">
                        <div class="card" style="border-radius: 1rem;">
                            <img src="../img/iphoneX.jpg" class="card-img-top" alt="...">
                            <div class="card-body">
                              <h5 class="card-title">iphone 14</h5>
                              <form action="cart.php" method="post">
                                <input type="number" name="soluong" min="1" max="10" value="1" style="margin-bottom: 1px;">
                                <input type="submit" name="addGiohang" value="19.000.000đ">
                                <input type="hidden" name="hinh" value="iphoneX.jpg">
                                <input type="hidden" name="ten" value="iphoneX">
                                <input type="hidden" name="gia" value="19000000">
